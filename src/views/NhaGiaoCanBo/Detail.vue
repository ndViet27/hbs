...
const loadConfiguration = async () => {
  try {
    ...
    quaTrinhCongTac.value = getTab("quaTrinhCongTac");
      ...
      >
        ...
        >
          ...
          <v-window v-model="currentTabId" class="mt-4">
              ...
              <v-row class="mx-0 my-0">
                <v-col>
                  <v-row
                    ...
                    v-if="
                      thongTinCaNhan.formInfo && thongTinCaNhan.formInfo.length
                    "
                  >
                    <template
            ...
            <v-window-item value="quaTrinhCongTac">
              <v-row class="mx-0 my-0">
                <v-col>
                  <v-row
                    class="mx-0 my-0 px-0"
                    v-if="
                      quaTrinhCongTac.formInfo && quaTrinhCongTac.formInfo.length
                    "
                  >
                    <template
                      v-for="(item, index) in quaTrinhCongTac.formInfo"
                      v-bind:key="index"
                    >
                      <v-col :class="item['class']">
                        <span class="label-text font-weight-medium mr-2">
            ...
            <v-window-item value="vanBangChungChi"> </v-window-item>
            <v-window-item value="chungThuSo"> </v-window-item>
          </v-window>
        </div>
      </v-card>
    </template>
